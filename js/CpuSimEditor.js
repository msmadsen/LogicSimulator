...
m.getModuleObj('210703703490073').setPos(new Vector2d(40, -192));
m.addModuleObj('GateNand', '1786075225377137');
m.getModuleObj('1786075225377137').setPos(new Vector2d(40, -128));
m.addModuleObj('GateNand', '357636025264273');
m.getModuleObj('357636025264273').setPos(new Vector2d(112, -192));
m.addModuleObj('GateNand', '66289046316293');
m.getModuleObj('66289046316293').setPos(new Vector2d(112, -128));
m.addModuleObj('GateNand', '1828942722316352');
m.getModuleObj('1828942722316352').setPos(new Vector2d(240, -192));
m.addModuleObj('GateNand', '2562901624143721');
m.getModuleObj('2562901624143721').setPos(new Vector2d(312, -192));
m.addModuleObj('GateNand', '47982791049880');
m.getModuleObj('47982791049880').setPos(new Vector2d(240, -128));
m.addModuleObj('GateNand', '189667895452435');
m.getModuleObj('189667895452435').setPos(new Vector2d(312, -128));
m.addModuleObj('GateNand', '354958625380390');
m.getModuleObj('354958625380390').setPos(new Vector2d(40, -48));
m.addModuleObj('GateNand', '25630739345875');
m.getModuleObj('25630739345875').setPos(new Vector2d(112, -48));
m.addModuleObj('GateNand', '2100539225792921');
m.getModuleObj('2100539225792921').setPos(new Vector2d(40, 16));
m.addModuleObj('GateNand', '434365526314084');
m.getModuleObj('434365526314084').setPos(new Vector2d(112, 16));
m.addModuleObj('GateNand', '253965454364345');
m.getModuleObj('253965454364345').setPos(new Vector2d(240, -48));
m.addModuleObj('GateNand', '766776517912116');
m.getModuleObj('766776517912116').setPos(new Vector2d(312, -48));
m.addModuleObj('GateNand', '2211259322497383');
m.getModuleObj('2211259322497383').setPos(new Vector2d(240, 16));
m.addModuleObj('GateNand', '966836817372005');
m.getModuleObj('966836817372005').setPos(new Vector2d(312, 16));
m.addModuleObj('Clock', '76162721332051');
m.getModuleObj('76162721332051').setPos(new Vector2d(-208, -328));
m.addModuleObj('GateNand', '2256974917203986');
m.getModuleObj('2256974917203986').setPos(new Vector2d(184, -320));
m.addModuleObj('WireLink', '78831293503377');
m.getModuleObj('78831293503377').setPos(new Vector2d(200, -136));
m.addModuleObj('WireLink', '98975241640471');
m.getModuleObj('98975241640471').setPos(new Vector2d(200, 16));
...
m.getModuleObj('7411552607490').setPos(new Vector2d(112, -296));
m.addModuleObj('WireLink', '180967743692579');
m.getModuleObj('180967743692579').setPos(new Vector2d(24, -296));
m.addModuleObj('GateNand', '35333020472611');
m.getModuleObj('35333020472611').setPos(new Vector2d(-72, -184));
...
m.getModuleObj('1994072823429731').setPos(new Vector2d(-152, -184));
...
m.getModuleObj('100568552655012').setPos(new Vector2d(-200, -152));
...
m.getModuleObj('2152171924264787').setPos(new Vector2d(-208, -264));
m.addModuleObj('WireLink', '2362604834834');
m.getModuleObj('2362604834834').setPos(new Vector2d(-272, -240));
m.addModuleObj('Input', '794716018945681');
m.getModuleObj('794716018945681').setPos(new Vector2d(-248, -328));
m.addModuleObj('GateNand', '201415684606274');
m.getModuleObj('201415684606274').setPos(new Vector2d(-272, -136));
m.addModuleObj('GateNand', '62971709793651');
m.getModuleObj('62971709793651').setPos(new Vector2d(-272, -8));
m.addModuleObj('GateNand', '263127373568998');
m.getModuleObj('263127373568998').setPos(new Vector2d(-368, -168));
m.addModuleObj('GateNand', '767753618434169');
m.getModuleObj('767753618434169').setPos(new Vector2d(-368, -104));
m.addModuleObj('GateNand', '793094917072423');
m.getModuleObj('793094917072423').setPos(new Vector2d(-368, -40));
m.addModuleObj('GateNand', '2156651522238789');
m.getModuleObj('2156651522238789').setPos(new Vector2d(-368, 24));
m.addModuleObj('WireLink', '349058017059956');
m.getModuleObj('349058017059956').setPos(new Vector2d(448, -168));
m.addModuleObj('WireLink', '2308926616873319');
m.getModuleObj('2308926616873319').setPos(new Vector2d(432, -24));
m.addModuleObj('WireLink', '1410639711988');
m.getModuleObj('1410639711988').setPos(new Vector2d(432, 112));
m.addModuleObj('WireLink', '218037123632169');
m.getModuleObj('218037123632169').setPos(new Vector2d(472, 136));
m.addModuleObj('WireLink', '170660966586485');
m.getModuleObj('170660966586485').setPos(new Vector2d(-552, 112));
m.addModuleObj('WireLink', '1822756019464449');
m.getModuleObj('1822756019464449').setPos(new Vector2d(-592, 136));
m.addModuleObj('WireLink', '1907739524662576');
m.getModuleObj('1907739524662576').setPos(new Vector2d(-560, -184));
m.addModuleObj('WireLink', '18100585340375');
m.getModuleObj('18100585340375').setPos(new Vector2d(-616, -200));
m.addModuleObj('GateNand', '237275519464802');
m.getModuleObj('237275519464802').setPos(new Vector2d(-512, -264));
m.addModuleObj('GateNand', '262280071586774');
m.getModuleObj('262280071586774').setPos(new Vector2d(-520, -336));
m.addModuleObj('WireLink', '224474423082565');
m.getModuleObj('224474423082565').setPos(new Vector2d(-560, -312));
...
m.getModuleObj('2255747218313269').setPos(new Vector2d(-424, -152));
m.addModuleObj('WireLink', '10529509930260');
m.getModuleObj('10529509930260').setPos(new Vector2d(-424, -136));
m.addModuleObj('WireLink', '524912724319826');
m.getModuleObj('524912724319826').setPos(new Vector2d(-424, -88));
m.addModuleObj('WireLink', '2647838818433537');
m.getModuleObj('2647838818433537').setPos(new Vector2d(-424, -72));
m.addModuleObj('WireLink', '567402319957381');
m.getModuleObj('567402319957381').setPos(new Vector2d(-424, -24));
m.addModuleObj('WireLink', '2638032324327193');
m.getModuleObj('2638032324327193').setPos(new Vector2d(-424, -8));
m.addModuleObj('WireLink', '452747621203043');
m.getModuleObj('452747621203043').setPos(new Vector2d(-424, 40));
m.addModuleObj('WireLink', '194289194293669');
m.getModuleObj('194289194293669').setPos(new Vector2d(-424, 56));
